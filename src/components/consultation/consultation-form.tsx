  ...
  return (
    <form className="grid gap-6 px-4 sm:gap-8 sm:px-6 md:px-12">
      <div className="grid gap-6 sm:gap-8 md:grid-cols-2">
        <LuxuryInput label="01. Nom complet" name="fullName" placeholder="Aya Konan" />
        <LuxuryInput label="02. Téléphone" name="phone" placeholder="+225 07 00 00 00 00" />
      </div>
      <LuxuryInput label="03. Adresse email" name="email" placeholder="aya.konan@exemple.ci" />
      <div className="grid gap-6 sm:gap-8 md:grid-cols-2">
